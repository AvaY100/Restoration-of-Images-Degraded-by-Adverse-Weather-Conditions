...
def save_image(dehaze, image_name, category):
    ...
    for ind in range(batch_num):
        utils.save_image(dehaze_images[ind], './{}_results/{}'.format(category, os.path.basename(image_name[ind])[:-3] + 'png'))


def print_log(epoch, num_epochs, one_epoch_time, train_psnr, val_psnr, val_ssim, log_file):
